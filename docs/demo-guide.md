...
5. **2:30–3:05 — Corpus and graph.** Show 362 source records, including 108 synthetic records. The additional Jira/Confluence/SharePoint documents model future native-MCP reads, not live connections. Explore the BSP requirement and highlight retrieved nodes. Change the graph control and return to the retained answer. Briefly show Mentor Mode's review checklist.
